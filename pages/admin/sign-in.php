...
<body class="sign-in-basic">
        ...
        <div class="col-lg-4 col-md-8 col-12 mx-auto">
          <div class="card z-index-0 fadeIn3 fadeInBottom">
            <div class="card-body">
              ...
              <form id="adminLogin" role="form" class="text-start">
                ...
                <div class="input-group input-group-outline mb-3">
                  ...
                  <input type="password" class="form-control" name="adminLogPassword" required />
                </div>
  ...
  <script src="../../assets/custom-scripts/adminRegistration.js" type="text/javascript"></script>
